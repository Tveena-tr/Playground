...
public class MainActivity extends AppCompatActivity implements Adapter.OnItemClickListener {
    ...
    public void onItemClick(int position) {
        ...
        activity_2Intent.putExtra(EXTRA_URL, clickedItem.getmImageUrl());
        activity_2Intent.putExtra(EXTRA_CREATOR, clickedItem.getmCreator());
        activity_2Intent.putExtra(EXTRA_LIKES, clickedItem.getmLikes());
        activity_2Intent.putExtra(EXTRA_COMMENTS, clickedItem.getmComments());
